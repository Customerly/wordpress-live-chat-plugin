            ...
            <div class="customer-quote-container">
                ...
                <div class="customer-quote-text-container">
                    <div class="customer-quote-text">
                        "Customerly transforms the daily customer service activity in an opportunity to
                        generate
                        more sales."
                    </div>
                    <div class="customer-quote-name">
                        Irene,<span class="customer-business-name">
Head of Customer Care @Shampora <br> eCommerce for tailored Shampoo </span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="live-chat-features">
        ...
        <div class="live-chat-feature-container">
            ...
            <p>
                Handle all incoming conversation from <strong>Facebook Messenger </strong>, <strong>Live
                    Chat</strong> or <strong>Support Email</strong> in just one place...<br> Your New, Amazing,
                Dashboard.
            </p>
        </div>
        ...
        <div class="live-chat-feature-container">
            ...
            <p>
                Wanna know their mobile phone? <br> <strong>Let our Live Chat ask them automatically for
                    you</strong> and find it in your dashboard before you open it.
            </p>
        </div>
        ...
        <div class="live-chat-feature-container">
            ...
            <p>
                Forget Skype, Teamviewer and so on. <br><strong>No needs to install another service to see your
                    customers or their screen</strong>.
            </p>
        </div>
        ...
        <div class="live-chat-feature-container">
            ...
            <p>
                Want to prioritize some tickets? Have a team dedicated to accounting? <strong>Assign incoming
                    conversations automatically. Save 40% of your time</strong>.
            </p>
        </div>
        ...
        <div class="live-chat-feature-container">
            ...
            <p>
                ...
                perfectly integrated with your Dashboard
            </p>
        </div>
...
<div class="container">
    ...
    <div class="customers-quotes">
        ...
        <div class="customer-quote-container">
            ...
            <div class="customer-quote-text-container">
                <div class="customer-quote-text">
                    "Customerly is simply the best way to manage and improve your customer service.
                    Customer satisfaction should be your number one goal and Customerly is the top notch
                    tool to reach that."
                </div>
                <div class="customer-quote-name">
                    Raffaele, <span class="customer-business-name">Growth Hacker </span>
                </div>
            </div>
        </div>
